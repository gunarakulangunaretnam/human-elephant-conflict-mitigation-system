                        ...
                        <div class="col-md-3 offset-md-3 col-lg-3 offset-lg-4">
                            <div class="input-group input-group-sm mb-3">
                                <div class="input-group-prepend">
                                    <span style="font-weight: bold;" class="input-group-text"
                                        id="inputGroup-sizing-sm">Filter by Month:</span>
                                </div>
                                <input type="month" value="{{ $YearMonth }}" id="month_picker" class="form-control"
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-lg font-weight-bold text-primary text-uppercase mb-1"
                                    style="text-align: center;">Total Incidents</div>
                                <div class="text-md h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;">
                                    {{ reset($TotalIncidents)->total_count }}</div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-lg font-weight-bold text-primary text-uppercase mb-1"
                                    style="text-align: center;">Total Elephants Detected</div>
                                <div class="text-md h5 mb-0 font-weight-bold text-gray-800" style="text-align: center;">
                                    {{ reset($TotalElephantsDetected)->total_count }}</div>
                            </div>
                            <div class="col-auto">
