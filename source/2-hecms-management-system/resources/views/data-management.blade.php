...
@section('content')
    <div class="container-fluid">
                ...
                <div class="col-md-3 offset-md-3 col-lg-3 offset-lg-4">
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <div style="text-align: center; margin-left:7%;">
                            ...
                            <input type="radio" id="show_all_data" name="search-type"
                                onclick="window.location.href='{{ route('DataManagementViewLink', ['search_by_date' => '[FALSE]']) }}'">
                            Show all data |
                        ...
                        <div class="input-group-prepend">
                            <span style="font-weight: bold;" class="input-group-text" id="inputGroup-sizing-sm">Search by
                                Date:</span>
                        </div>
                        <input type="date" id="date_picker" class="form-control" aria-label="Small"
        ...
        <div class="row">
            <table style="background-color: white; border: 5px solid rgb(197, 189, 189); width: 100%;"
                    ...
                    @foreach ($DataManagementData as $data)
                        <tr>
                            ...
                            <td style="width: 12%; vertical-align: middle;">
                                <a href="{{ route('ShowImageFunctionInNewPageViewLink', ['id' => $data->auto_id]) }}"
                                    target="_blank">
                                    <img style="width:100%; border-radius:5%;"
                                        src="data:image/jpeg;base64,{{ base64_encode($data->elephant_image) }}"
                                        alt="Elephant Image">
                                </a>
                            </td>
                        </tr>
        ...
        <script>
            window.onload = function() {
                ...
                document.getElementById('date_picker').addEventListener('change', function() {
                    ...
                    var url =
                        "{{ route('DataManagementViewLink', ['search_by_date' => ':date']) }}"; // Define the URL with a placeholder for the date parameter
