            ...
            <div class="row">
                <div class="col-md-3 col-lg-3">
                    ...
                    <form class="user" method="POST" action="{{ route('SettingsChangePasswordFunctionLink') }}">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <div class="input-group-prepend">
                                <span style="font-weight: bold;" class="input-group-text" id="inputGroup-sizing-sm">Current
                                    Password:</span>
                            </div>
                            <input type="password" name="current_password" class="form-control" aria-label="Small"
                                aria-describedby="inputGroup-sizing-sm" size="5" required>
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <div class="input-group-prepend">
                                <span style="font-weight: bold;" class="input-group-text" id="inputGroup-sizing-sm">New
                                    Password:</span>
                            </div>
                            <input type="password" name="new_password" class="form-control" aria-label="Small"
                                aria-describedby="inputGroup-sizing-sm" size="5" required>
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <div class="input-group-prepend">
                                <span style="font-weight: bold;" class="input-group-text" id="inputGroup-sizing-sm">Confirm
                                    Password:</span>
                            </div>
                            <input type="password" name="confirm_password" class="form-control" aria-label="Small"
                                aria-describedby="inputGroup-sizing-sm" size="5" required>
                        </div>
                        <button type="submit" class="btn btn-primary btn-sm">Change</button>
